...
| [nextcloud](roles/nextcloud/) | | Docker | Personal cloud pilot with files, groupware, built-in Nextcloud Office, Caddy routing, and fail-closed restore testing |
...
| nextcloud | `alloy.service`, `docker.service`, `firewalld.service` |
